...
export default function RootTabletNavigator (props) {
  ...
  return <Drawer ref={drawerRef} content={<SideBar closeFile={props.closeFile} closeDrawer={closeDrawer} logout={props.logout}/>} onClose={closeDrawer} openDrawerOffset={0.7}>
