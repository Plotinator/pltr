...
export default function RootPhoneNavigator (props) {
  ...
  return <ErrorBoundary>
    <Drawer ref={drawerRef} content={<SideBar closeFile={props.closeFile} closeDrawer={closeDrawer} logout={props.logout}/>} onClose={closeDrawer}>
      <RootStack.Navigator mode='modal'>
        ...
        <RootStack.Screen name='ColorPickerModal' component={ColorPickerScreen} options={{ title: t('Color Picker'), headerBackTitle: t('Back') }} />
      </RootStack.Navigator>
    </Drawer>
  </ErrorBoundary>
}
